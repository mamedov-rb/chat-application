...
@Testcontainers
abstract class IntegrationTestContextConfigurer extends Specification {

    public static DockerComposeContainer composeContainer =
            new DockerComposeContainer(new File("src/test/resources/integration-test-docker-compose.yaml"))
